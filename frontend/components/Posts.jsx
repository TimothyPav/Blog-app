...
export default function BlogPosts() {
  ...
  useEffect(() => {
    ...
    return (
        <div className='p-4'>
        {posts.map(post => (
            <div key={post._id} className="max-w-4xl mx-auto border-green-300 bg-white bg-opacity-60 border-4 rounded-xl shadow-md overflow-hidden mb-3 cursor-pointer">
              <div className="p-4">
